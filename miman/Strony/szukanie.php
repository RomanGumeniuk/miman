...
if(isset($_POST['szukaj'])){
        ...
        $sql = 'SELECT id_gry,ikonka FROM gry WHERE nazwa LIKE "%'.$szukaj.'%" or gatunek LIKE "%'.$szukaj.'%"';
        $wynik = mysqli_query($conn,$sql) or die("Oj nie wyszło") ;
        if (mysqli_num_rows($wynik) == 0){
            echo "Podana fraza -".$szukaj."- nie została odnaleziona";
        } else {
